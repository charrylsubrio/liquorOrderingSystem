...
void load_data() {
  ...
  while (fscanf(liquor_file, "%s %d %d %d", liquors[num_liquors].name, &liquors[num_liquors].price, &liquors[num_liquors].ml, &liquors[num_liquors].stock) != EOF) {
    num_liquors++;
