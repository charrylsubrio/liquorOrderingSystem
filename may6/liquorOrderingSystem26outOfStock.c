...
void order_liquor() {
    ...
    while (liquor_index == -1) {
        ...
        scanf("%s", liquor_name); // Read liquor name again
        liquor_index = find_liquor_index(liquor_name); // Check again for the updated liquor name
    }
    ...
    while (liquors[liquor_index].stock < quantity) {
        ...
        scanf("%d", &quantity); // Read quantity again
    }
